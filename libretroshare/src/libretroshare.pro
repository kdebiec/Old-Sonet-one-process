...
CONFIG += voip
voip {
    HEADERS +=  services/VOIP/p3notifyvoip.h \
                services/VOIP/p3voipservice.h \
                services/VOIP/rsnotifyvoip.h \
                services/VOIP/rsVOIP.h \
                services/VOIP/rsVOIPItems.h

    SOURCES +=  services/VOIP/p3notifyvoip.cpp \
                services/VOIP/p3voipservice.cpp \
                services/VOIP/rsVOIPItems.cc
}

CONFIG += wall
wall {
    HEADERS +=  services/wall/p3wallservice.h \
                services/wall/rswall.h \
                services/wall/rswallitems.h

    SOURCES +=  services/wall/p3wallservice.cc \
                services/wall/rswallitems.cc
}
