...
const uint32_t RS_FEED_TYPE_WALL     = 0x0080;
...
const uint32_t RS_FEED_ITEM_WALL_NEW        = RS_FEED_TYPE_WALL  | 0x0001;
//const uint32_t RS_FEED_ITEM_WALL_UPDATE   = RS_FEED_TYPE_WALL  | 0x0002;
const uint32_t RS_FEED_ITEM_WALL_MSG        = RS_FEED_TYPE_WALL  | 0x0003;
const uint32_t RS_FEED_ITEM_WALL_PUBLISHKEY = RS_FEED_TYPE_WALL  | 0x0004;
