    ...
    View {
        ...
        Rectangle{
            ...
            MouseArea{
                ...
                onClicked: overflowMenu3.open(drag, mouse.x, mouse.y);
                        ...
                        ListItem.Standard {
                            ...
                            onClicked: {
                                ...
                                if(!maximized)
                                {
                                    ...
                                    drag.row = Qt.binding(function() { return main.visibleRows})//parseInt(main.height / dp(60)) || 1})//gridLayout.rowspace-1})//parseInt(main.height / dp(60)) || 1})
                                    maximized = true
                                }
                                else if(maximized)
                                {
            ...
            Item{
                ...
                ListView{
                    ...
                    model:  ChatMsgModel{
                                ...
                                onUpdatedDisplay: contentm.positionViewAtEnd()
                            }
            ...
            View{
                ...
                TextArea{
                    ...
                    Keys.onPressed:{
                        ...
                        {
                            chatHandler.sendMsgViaGxs(drag.gxsId, msgBox.text);
                            msgModel.updateDisplay();
                            msgBox.text = "";
                            event.accepted = true;
                        }
                    }
