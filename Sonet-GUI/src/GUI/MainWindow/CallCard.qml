...
DragTile{
    ...
    VOIP{
        id: voip
        Component.onCompleted: drag.gxsId === "" ? voip.rspeerid = drag.rsPeerId : voip.gxs = drag.gxsId
        onAcceptReceived:{
    ...
    MouseArea{
        ...
        onClicked: overflowMenu6.open(drag, mouse.x, mouse.y);

        Dropdown {
            id: overflowMenu6
            objectName: "overflowMenu6"
                ...
                Ink {
                    ...
                    onClicked: {
                        if(mouse.button === Qt.LeftButton)
                            ...
                            overflowMenu10.open(circleInk, mouse.x, mouse.y);
                    }

                    Dropdown {
                        id: overflowMenu10
                        objectName: "overflowMenu10"
                        overlayLayer: "dialogOverlayLayer"
                        width: 200 * Units.dp
                        height: dp(3*30)
                        enabled: true
