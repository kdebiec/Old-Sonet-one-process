...
QApplication *MainWindow::a;

MainWindow::MainWindow( QApplication *app, HBRUSH windowBackground, const int x, const int y, const int width, const int height, QObject *parent ) : QObject(parent), hWnd( 0 ),
  ...
  switch ( message ) {
    ...
    case WM_SIZE: {
      ...
      if ( wp.showCmd == SW_MAXIMIZE )
        mainPanel->setGeometry( 8,8,winrect.right-16,winrect.bottom-16/*16, 16, winrect.right - 32, winrect.bottom - 32*/ );
      else
        mainPanel->setGeometry( 0,0,winrect.right,winrect.bottom/*8, 8, winrect.right - 16, winrect.bottom - 16*/ );
