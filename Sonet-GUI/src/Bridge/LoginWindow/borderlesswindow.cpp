  ...
  visible( false )
{
  ...
  hWnd = CreateWindow( L"WindowClass", L"Sonet", static_cast<DWORD>( Style::windowed ), x, y, width, height, 0, 0, hInstance, nullptr );
  ...
  switch ( message ) {
    ...
    case WM_SIZE: {
      ...
      if ( wp.showCmd == SW_MAXIMIZE )
        mainPanel->setGeometry( 0,0,winrect.right,winrect.bottom/*16, 16, winrect.right - 32, winrect.bottom - 32*/ );
      else
